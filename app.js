...
const postNotFound = "ERROR 404!! Page Not Found";
const app = express();
...
//   }
// })
// let posts = [];      //used when not connected to mongo db server
...
// 2nd method when posting to /posts/post._id and not to post title
